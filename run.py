...
SHEET = GSPREAD_CLIENT.open('love_sandwiches_pyprjct')
...
def get_sales_data():
    ...
    The loops will repeatedly request data until valid.
    """
    while True:
...
def get_stock_values(data):
    """
    Pull sandwich names from the sheet 
    and the calculated stock data.
    """
